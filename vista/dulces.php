...
$db = getDbConnection();
$stmt = $db->prepare("SELECT * FROM productos WHERE categoria = 'Dulces'");
$stmt->execute();
...
if (empty($products)) {
    $exampleProducts = [
        ['nombre' => 'Chocolate', 'descripcion' => 'Delicioso chocolate negro', 'precio' => 3000, 'imagen' => 'https://example.com/chocolate.jpg', 'categoria' => 'Dulces'],
        ['nombre' => 'Caramelos', 'descripcion' => 'Surtido de caramelos de frutas', 'precio' => 1500, 'imagen' => 'https://example.com/caramelos.jpg', 'categoria' => 'Dulces'],
        ['nombre' => 'Gomitas', 'descripcion' => 'Gomitas de ositos', 'precio' => 2000, 'imagen' => 'https://example.com/gomitas.jpg', 'categoria' => 'Dulces'],
        ['nombre' => 'Galletas', 'descripcion' => 'Galletas con chispas de chocolate', 'precio' => 2500, 'imagen' => 'https://example.com/galletas.jpg', 'categoria' => 'Dulces'],
        ['nombre' => 'Helado', 'descripcion' => 'Helado de vainilla', 'precio' => 3500, 'imagen' => 'https://example.com/helado.jpg', 'categoria' => 'Dulces'],
        ['nombre' => 'Pastel', 'descripcion' => 'Pastel de chocolate', 'precio' => 4000, 'imagen' => 'https://example.com/pastel.jpg', 'categoria' => 'Dulces'],
    ];
...
<head>
    ...
    <style>
        ...
        body {
            ...
            padding: 20px;
            min-height: 100vh;
            background-image: url('https://files.oaiusercontent.com/file-ULVojoQXbm7F3gVSFrg7L7?se=2024-11-22T21%3A58%3A05Z&sp=r&sv=2024-08-04&sr=b&rscc=max-age%3D604800%2C%20immutable%2C%20private&rscd=attachment%3B%20filename%3D2d529b45-8a63-416a-92be-cb0a977f1f2e.webp&sig=8zl0VCqHCKSmLzcGJjm6WmMekZZT5h7/hnAgBK5WN2Q%3D');
