...
$db = getDbConnection();
$stmt = $db->prepare("SELECT * FROM productos WHERE categoria IN ('Frutas', 'Bebidas')");
$stmt->execute();
$products = $stmt->fetchAll(PDO::FETCH_ASSOC);

if (empty($products)) {
    $exampleProducts = [
        ['nombre' => "Manzanas", 'descripcion' => "Manzanas frescas y crujientes", 'precio' => 2500, 'imagen' => "https://img.freepik.com/psd-gratis/cerca-manzana-aislada_23-2151598148.jpg", 'categoria' => "Frutas"],
        ['nombre' => "Plátanos", 'descripcion' => "Plátanos maduros y dulces", 'precio' => 1800, 'imagen' => "https://d2u1z1lopyfwlx.cloudfront.net/thumbnails/40680746-539b-5265-84e4-d10a1bdcd160/fdc560f6-4d25-5239-88e8-666a41f1a0c6.jpg", 'categoria' => "Frutas"],
        ['nombre' => "Naranjas", 'descripcion' => "Naranjas jugosas y llenas de vitamina C", 'precio' => 2200, 'imagen' => "https://www.ouinolanguages.com/thumb/Spanish/vocab/12/images/pic12.jpg", 'categoria' => "Frutas"],
        ['nombre' => "Fresas", 'descripcion' => "Fresas rojas y aromáticas", 'precio' => 3500, 'imagen' => "https://d2u1z1lopyfwlx.cloudfront.net/thumbnails/45c07b8e-5053-5353-bd81-57fb2509f31a/b9c42c2f-ef19-5acc-9787-f416a49c06bc.jpg", 'categoria' => "Frutas"],
        ['nombre' => "Uvas", 'descripcion' => "Racimos de uvas verdes y moradas", 'precio' => 4000, 'imagen' => "https://d2u1z1lopyfwlx.cloudfront.net/thumbnails/cf387232-57a6-592a-8023-a5f2f7541e73/428cf7a2-6f52-5125-bb0a-50a781b3f331.jpg", 'categoria' => "Frutas"],
        ['nombre' => "Piña", 'descripcion' => "Piña tropical dulce y refrescante", 'precio' => 3200, 'imagen' => "https://d2u1z1lopyfwlx.cloudfront.net/thumbnails/3587d4fe-c344-5d5a-9c93-66e095381f55/19fff8e5-c8d2-5bcc-b34c-43e2ef28b80a.jpg", 'categoria' => "Frutas"],
        ['nombre' => 'Agua Mineral', 'descripcion' => 'Agua pura y refrescante', 'precio' => 1500, 'imagen' => 'https://static.merqueo.com/images/products/large/f6fc3d4f-e634-4743-a582-3d65cb925202.jpg', 'categoria' => 'Bebidas'],
        ['nombre' => 'CocaCola', 'descripcion' => 'Bebida gaseosa con sabor a cola', 'precio' => 2500, 'imagen' => 'https://tb-static.uber.com/prod/image-proc/processed_images/117bf5724c43e279c31ecb46e80ef4b4/957777de4e8d7439bef56daddbfae227.jpeg', 'categoria' => 'Bebidas'],
        ['nombre' => 'Jugo de Naranja', 'descripcion' => '100% jugo natural de naranja', 'precio' => 2000, 'imagen' => 'https://m.media-amazon.com/images/I/41QtxymW5xL.jpg', 'categoria' => 'Bebidas'],
        ['nombre' => 'Té Helado', 'descripcion' => 'Té negro con un toque de limón', 'precio' => 2000, 'imagen' => 'https://t1.uc.ltmcdn.com/es/posts/5/8/3/como_preparar_te_helado_15385_orig.jpg', 'categoria' => 'Bebidas'],
        ['nombre' => 'Cerveza Artesanal', 'descripcion' => 'Cerveza local con sabor único', 'precio' => 2500, 'imagen' => 'https://imagenes.elpais.com/resizer/v2/6RWBVMD53ZAJDFKUH5JSRW5GTE.jpg?auth=cfab58f79eaab39f949dde6d1dc4332e85ff65babbd7b79bee6a0dbece9853d9&width=1200', 'categoria' => 'Bebidas'],
        ['nombre' => 'Limonada', 'descripcion' => 'Refrescante bebida de limón natural', 'precio' => 1500, 'imagen' => 'https://s3.ppllstatics.com/diariosur/www/pre2017/multimedia/noticias/201602/16/media/cortadas/limonada._xoptimizadax--490x578.jpg', 'categoria' => 'Bebidas'],
    ];
...
<head>
    ...
    <style>
        ...
        body {
            ...
            padding: 20px;
            min-height: 100vh;
            background-image: url('https://files.oaiusercontent.com/file-G2aRCiDqE35dQabtpnzYrGVN?se=2024-11-18T17%3A08%3A53Z&sp=r&sv=2024-08-04&sr=b&rscc=max-age%3D604800%2C%20immutable%2C%20private&rscd=attachment%3B%20filename%3D855ef7ab-7047-4d41-956b-6043e9a62221.webp&sig=bOxJ58RlEQj1jv0dsCCvUglZs81n6HeI5X/2%2BBZ0pHA%3D');
