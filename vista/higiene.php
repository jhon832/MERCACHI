...
$db = getDbConnection();
$stmt = $db->prepare("SELECT * FROM productos WHERE categoria = 'Higiene'");
$stmt->execute();
$products = $stmt->fetchAll(PDO::FETCH_ASSOC);

if (empty($products)) {
    $exampleProducts = [
        ['nombre' => 'Jabón de Manos', 'descripcion' => 'Suave y antibacterial', 'precio' => 3500, 'imagen' => 'https://www.protex-soap.com/content/dam/cp-sites/personal-care/protex-relaunch/latam/products/jabon-liquido-avena-prebiotico-221ml.jpg', 'categoria' => 'Higiene'],
        ['nombre' => 'Champú Anticaspa', 'descripcion' => 'Limpieza profunda del cuero cabelludo', 'precio' => 12000, 'imagen' => 'https://m.media-amazon.com/images/I/61ehqViIK2L.jpg', 'categoria' => 'Higiene'],
        ['nombre' => 'Pasta de Dientes Blanqueadora', 'descripcion' => 'Para una sonrisa brillante', 'precio' => 8000, 'imagen' => 'https://m.media-amazon.com/images/I/61iyUw9eSvL._AC_UF1000,1000_QL80_.jpg', 'categoria' => 'Higiene'],
        ['nombre' => 'Desodorante Roll-on', 'descripcion' => 'Protección 24 horas', 'precio' => 7500, 'imagen' => 'https://m.media-amazon.com/images/I/91sMxlpXLBL._AC_UF1000,1000_QL80_.jpg', 'categoria' => 'Higiene'],
        ['nombre' => 'Gel de Ducha', 'descripcion' => 'Con aroma refrescante', 'precio' => 9000, 'imagen' => 'https://cdn.shopify.com/s/files/1/0563/4375/6869/products/63554f6-0efbed9-lavanda_dim2.png?height=512&width=512', 'categoria' => 'Higiene'],
        ['nombre' => 'Cepillo de Dientes', 'descripcion' => 'Cerdas suaves y ergonómico', 'precio' => 5000, 'imagen' => 'https://m.media-amazon.com/images/I/51hSzh1H+8L._AC_UF1000,1000_QL80_.jpg', 'categoria' => 'Higiene'],
    ];
...
<head>
    ...
    <style>
        ...
        body {
            ...
            padding: 20px;
            min-height: 100vh;
            background-image: url("https://files.oaiusercontent.com/file-hfSDSpLtHWLuKXTx9FMsvcWo?se=2024-11-18T17%3A10%3A56Z&sp=r&sv=2024-08-04&sr=b&rscc=max-age%3D604800%2C%20immutable%2C%20private&rscd=attachment%3B%20filename%3D797307e7-a556-4b89-97f6-de6ba33cf919.webp&sig=vG91VZXiqviLmH5qH4ic5S2VPZJ7YsYXRZivaRtko10%3D");
