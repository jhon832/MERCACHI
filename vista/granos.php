...
$db = getDbConnection();
$stmt = $db->prepare("SELECT * FROM productos WHERE categoria = 'Granos'");
$stmt->execute();
$products = $stmt->fetchAll(PDO::FETCH_ASSOC);

if (empty($products)) {
    $exampleProducts = [
        ['nombre' => 'Arroz Blanco', 'descripcion' => 'Grano largo de alta calidad', 'precio' => 2500, 'imagen' => 'https://d2u1z1lopyfwlx.cloudfront.net/thumbnails/c1fba3bc-afe4-5090-96fc-6c646658534f/33e51ad1-1dc1-56f7-855e-363942bda5ad.jpg', 'categoria' => 'Granos'],
        ['nombre' => 'Frijoles Negros', 'descripcion' => 'Ricos en proteínas y fibra', 'precio' => 3200, 'imagen' => 'https://media.gettyimages.com/id/1205070106/es/foto/overhead-view-of-spoon-and-bowl-of-black-bean-on-wooden-table.jpg?s=612x612&w=0&k=20&c=9Sc8IpbNX0SBrMfLg3wfWPSpgj_NGDsc38Ni9KLJlpU=', 'categoria' => 'Granos'],
        ['nombre' => 'Lentejas', 'descripcion' => 'Nutritivas y versátiles', 'precio' => 2800, 'imagen' => 'https://media.gettyimages.com/id/186804026/es/foto/usan-las-lentejas-y-la-cuchara.jpg?s=612x612&w=0&k=20&c=-Fv5c9YdrhC1OSoExGPCQfQ7EK2JizmGhJnbjsZirNw=', 'categoria' => 'Granos'],
        ['nombre' => 'Garbanzos', 'descripcion' => 'Ideales para hummus y ensaladas', 'precio' => 3500, 'imagen' => 'https://media.gettyimages.com/id/136239617/es/foto/chick-guisantes.jpg?s=612x612&w=0&k=20&c=LuS5GQjYFahaEPbCIj30YhOp_Y0eIpd6_ubFa9La4as=', 'categoria' => 'Granos'],
        ['nombre' => 'Quinoa', 'descripcion' => 'Superalimento rico en proteínas', 'precio' => 6000, 'imagen' => 'https://media.gettyimages.com/id/171320698/es/foto/quinua.jpg?s=612x612&w=0&k=20&c=-BbwRMLpYty5djJ38rp9AOyYxZp2zALJD8kbOegJMmc=', 'categoria' => 'Granos'],
        ['nombre' => 'Maíz para Palomitas', 'descripcion' => 'Granos seleccionados de alta calidad', 'precio' => 3000, 'imagen' => 'https://media.gettyimages.com/id/171374946/es/foto/y-las-palomitas-de-ma%C3%ADz.jpg?s=612x612&w=0&k=20&c=nKDMIAVy9aXozzvgiszavxSZHwHx3v6QgLHKhlY-JKg=', 'categoria' => 'Granos'],
    ];
...
<head>
    ...
    <style>
        ...
        body {
            ...
            padding: 20px;
            min-height: 100vh;
            background-image: url("https://files.oaiusercontent.com/file-FA8YTgCV7hjzAqkHKxwiR06R?se=2024-11-18T17%3A10%3A01Z&sp=r&sv=2024-08-04&sr=b&rscc=max-age%3D604800%2C%20immutable%2C%20private&rscd=attachment%3B%20filename%3Db5966df1-5a4a-4ad4-80ff-39b6d52913f2.webp&sig=05nflJQb4Vhs%2BneOWqs9TwxK1q8E6J10BBzauEN4fQ8%3D");
